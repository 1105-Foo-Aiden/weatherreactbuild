...
export default function Home() {
  ...
  return (
    <>
        ...
        <div>
          <div className="pt-20 pr-20 grid justify-center grid-rows-5 gap-0">
            ...
            <div className="flex items-center">
              <p className="text-[60px] flex justify-center">{forecastData && Math.round(forecastData.list[0].main.temp)}F/</p>
      ...
      <div className="container grid grid-cols-5 pl-10">
        <DayForcastComponent dateMultipler={2} Max={DayOneMax} Min={DayOneMin} Status={StatusDay1}/>
        <DayForcastComponent dateMultipler={3} Max={DayTwoMax} Min={DayTwoMin} Status={StatusDay2} />
        <DayForcastComponent dateMultipler={4} Max={DayThreeMax} Min={DayThreeMin} Status={StatusDay3} />
        <DayForcastComponent dateMultipler={5} Max={DayFourMax} Min={DayFourMin} Status={StatusDay4} />
        <DayForcastComponent dateMultipler={2} Max={DayFiveMax} Min={DayFiveMin} Status={StatusDay5} />
      </div>
    </>
  );
}
